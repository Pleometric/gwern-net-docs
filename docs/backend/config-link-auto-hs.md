...
**Archived use:** `LinkAuto.customDefinitions`
**Calls:** (pure data)
...
**Archived use:** `LinkAuto.linkAutoTest`
...
- **[LinkAuto](link-auto-hs)** — Archived consumer that applied patterns to documents
- **Archived LinkAuto tests** — Historical validation data retained with the old module

### Validation

The archived test path performed several checks:
