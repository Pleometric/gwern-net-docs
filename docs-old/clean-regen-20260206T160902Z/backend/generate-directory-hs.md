...
**Key arguments:**
- `--fast`: Skip regular directory generation; `newest` is generated only if `length dirs > 5` or explicitly requested, and `/blog/` is not generated by this script
...
- `MetadataItem`: `(title, author, date, dateCreated, keyValues, tags, abstract)` tuple
